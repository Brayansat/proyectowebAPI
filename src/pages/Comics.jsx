...
// https://gateway.marvel.com:443/v1/public/comics?limit=50&apikey=
...
const Comics = () => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://gateway.marvel.com:443/v1/public/comics?ts=1&limit=100&apikey=787c7db569498ca082aed35152ede826&hash=38cf9265c36a7a70e5641f00691f08cf"
      )
      .then((res) => {
  ...
  return (
    <div className="App">
      ...
      <div className="flex flex-wrap my-7 justify-center gap-6 items-center">
        {data.map((comic) => {
          return (
            <div className="cardHeroe" key={comic.id}>
